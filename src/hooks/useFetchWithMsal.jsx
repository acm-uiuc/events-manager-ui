...
const useFetchWithMsal = (msalRequest) => {
    ...
    const { result2, error: msalError2 } = useMsalAuthentication(InteractionType.Popup, {
        ...msalRequest,
        account: instance.getActiveAccount(),
        redirectUri: '/redirect.html'
    });
    /**
     * Get the user's Access Token if we have it.
     * @returns Token
     */
    ...
    return {
        ...
        getToken: useCallback(getToken, [result2, msalError2]), // to avoid infinite calls when inside a `useEffect`
